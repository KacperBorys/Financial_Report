...
def calc(wartosci_z_danego_roku, wartosci_z_roku_poprzedniego):
    ...
    wskazniki["wsk_plynnosci_szybkiej"] = round(
        (wartosci_z_danego_roku["AKTYWA OBROTOWE"] - wartosci_z_danego_roku["Zapasy"]) / (
            wartosci_z_danego_roku["ZOBOWIĄZANIA KRÓTKOTERMINOWE"]), 2)
    ...
    wskazniki["wsk_ogolnego_zadluzenia"] = round((
            (wartosci_z_danego_roku["ZOBOWIĄZANIA DŁUGOTERMINOWE"] + wartosci_z_danego_roku[
                "ZOBOWIĄZANIA KRÓTKOTERMINOWE"]) / wartosci_z_danego_roku["AKTYWA RAZEM"]), 2)
    ...
    wskazniki["AKTYWA/KAPITAŁ"] = round((wartosci_z_danego_roku["AKTYWA RAZEM"] /
                              wartosci_z_danego_roku["KAPITAŁ WŁASNY"]), 2)
    wskazniki["SPRZEDAŻ_OGÓŁEM"] =round((wartosci_z_danego_roku["Przychody ze sprzedaży"] /
                              wartosci_z_danego_roku["AKTYWA RAZEM"]), 2)
    return wskazniki
...
# Wykres2
t_3 = [wartosci2017["Koszty sprzedanych produktów, usług, towarów i materiałów"],
       wartosci2018["Koszty sprzedanych produktów, usług, towarów i materiałów"],
       wartosci2019["Koszty sprzedanych produktów, usług, towarów i materiałów"],
       wartosci2020["Koszty sprzedanych produktów, usług, towarów i materiałów"]]
...
wskps2020_label = tk.Label(root, text=f'AKTYWA/KAPITAŁ = {wskazniki_2020["wsk_plynnosci_szybkiej"]}',
                           background="#00A8E8", foreground="#fff", font=(None, 16))
wskps2020_label.grid(row=6, column=2, padx=18, pady=12)

wskpb2020_label = tk.Label(root, text=f'SPRZEDAŻ_OGÓŁEM = {wskazniki_2020["wsk_plynnosci_biezacej"]}',
                           background="#00A8E8", foreground="#fff", font=(None, 16))
wskpb2020_label.grid(row=7, column=2, padx=18, pady=12)

roe2020_label = tk.Label(root, text=f'ROE = {wskazniki_2020["ROE"]}', background="#00A8E8", foreground="#fff",
                         font=(None, 16))
roe2020_label.grid(row=8, column=2, padx=18, pady=12)

roa2020_label = tk.Label(root, text=f'ROA = {wskazniki_2020["ROA"]}', background="#00A8E8", foreground="#fff",
                         font=(None, 16))
roa2020_label.grid(row=9, column=2, padx=18, pady=12)

ros2020_label = tk.Label(root, text=f'ROS = {wskazniki_2020["ROS"]}', background="#00A8E8", foreground="#fff",
                         font=(None, 16))
...
wskps2019_label = tk.Label(root, text=f'AKTYWA/KAPITAŁ = {wskazniki_2019["wsk_plynnosci_szybkiej"]}',
                           background="#95eb34", foreground="#fff", font=(None, 16))
wskps2019_label.grid(row=6, column=1, padx=18, pady=12)

wskpb2019_label = tk.Label(root, text=f'SPRZEDAŻ_OGÓŁEM = {wskazniki_2019["wsk_plynnosci_biezacej"]}',
                           background="#95eb34", foreground="#fff", font=(None, 16))
wskpb2019_label.grid(row=7, column=1, padx=18, pady=12)

roe2019_label = tk.Label(root, text=f'ROE = {wskazniki_2019["ROE"]}', background="#95eb34", foreground="#fff",
                         font=(None, 16))
roe2019_label.grid(row=8, column=1, padx=18, pady=12)

roa2019_label = tk.Label(root, text=f'ROA = {wskazniki_2019["ROA"]}', background="#95eb34", foreground="#fff",
                         font=(None, 16))
roa2019_label.grid(row=9, column=1, padx=18, pady=12)

ros2019_label = tk.Label(root, text=f'ROS = {wskazniki_2019["ROS"]}', background="#95eb34", foreground="#fff",
                         font=(None, 16))
...
wskps2018_label = tk.Label(root, text=f'AKTYWA/KAPITAŁ = {wskazniki_2018["wsk_plynnosci_szybkiej"]}',
                           background="#eb4034", foreground="#fff", font=(None, 16))
wskps2018_label.grid(row=6, column=0, padx=18, pady=12)

wskpb2018_label = tk.Label(root, text=f'SPRZEDAŻ_OGÓŁEM = {wskazniki_2018["wsk_plynnosci_biezacej"]}',
                           background="#eb4034", foreground="#fff", font=(None, 16))
wskpb2018_label.grid(row=7, column=0, padx=18, pady=12)

roe2018_label = tk.Label(root, text=f'ROE = {wskazniki_2018["ROE"]}', background="#eb4034", foreground="#fff",
                         font=(None, 16))
roe2018_label.grid(row=8, column=0, padx=18, pady=12)

roa2018_label = tk.Label(root, text=f'ROA = {wskazniki_2018["ROA"]}', background="#eb4034", foreground="#fff",
                         font=(None, 16))
roa2018_label.grid(row=9, column=0, padx=18, pady=12)

ros2018_label = tk.Label(root, text=f'ROS = {wskazniki_2018["ROS"]}', background="#eb4034", foreground="#fff",
                         font=(None, 16))
